...
class LoveHeaven extends paperback_extensions_common_1.Source {
    constructor(cheerio) {
        super(cheerio);
    }
    get version() { return '0.2.2'; }
    get name() { return 'LoveHeaven'; }
    get description() { return 'Extension that pulls manga from LoveHeaven. Thumbnails are currently broken.'; }
